 ...
 * Reserved.FileName: MXLogger.java@author: karlatemp@vip.qq.com: 19-9-18 下午5:54@version: 2.0
 */
...
public class MXLogger extends Logger {
    ...
    public MXLogger log(Level lv, String ln) {
        return log(lv, lv == Level.INFO ? getPrefix(ln) : getErrorPrefix(ln), ln);
    }
    ...
    public MXLogger printf(String line) {
        if (out != null) {
            out.log(Level.INFO, Ascii.ec(this.getPrefix(line), line, Ascii.RESET));
            return this;
        }
    ...
    public MXLogger error(String line) {
        if (out != null) {
            out.log(Level.SEVERE, Ascii.ec(this.getErrorPrefix(line), line, Ascii.RESET));
            return this;
        }
