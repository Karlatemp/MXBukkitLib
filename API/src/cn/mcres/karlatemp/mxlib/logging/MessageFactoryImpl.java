 ...
 * Reserved.FileName: MessageFactoryImpl.java@author: karlatemp@vip.qq.com: 19-9-18 下午5:54@version: 2.0
 */
...
public class MessageFactoryImpl implements IMessageFactory {
    protected String unuri(String x) {
        return CharCompiler.encode('%', x, StandardCharsets.UTF_8);
    }
