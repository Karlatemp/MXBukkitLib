...
public class ISv1_13_R2 extends ItemStackNBT {
    public NBTTagCompound compound(ItemStack item) {
        var ng = new net.minecraft.server.v1_13_R2.NBTTagCompound();
        CraftItemStack.asNMSCopy(item).save(ng);
        var out = new ByteArrayOutputStream();
        try {
            net.minecraft.server.v1_13_R2.NBTCompressedStreamTools.a(ng, (DataOutput) new DataOutputStream(out));
    ...
    public ItemStack compound(NBTTagCompound nbt) {
        ...
        try {
            ...
            return CraftItemStack.asCraftMirror(net.minecraft.server.v1_13_R2.ItemStack.a(net.minecraft.server.v1_13_R2.NBTCompressedStreamTools.a(new ByteArrayInputStream(out.toByteArray()))));
        } catch (IOException ioe) {
            return null;
        }
    }
