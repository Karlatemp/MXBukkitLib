...
package cn.mcres.karlatemp.unsafe;/*jdk.internal.misc*/
 ...
 * @see jdk.internal.misc.Unsafe#getUnsafe()
 * @see sun.misc.Unsafe
...
public abstract class Unsafe {
    ...
    private static Unsafe install() {
        try {
            ...
            final Method exports0 = Module.class.getDeclaredMethod("addExports0", Module.class, String.class, Module.class);
            final Module module = Object.class.getModule();
            final Module current = Unsafe.class.getModule();
            System.getSecurityManager();
            if (!module.isExported("jdk.internal.misc", current)) {
                AccessToolkit.setAccessible(exports0, true);
                exports0.invoke(null, module, "jdk.internal.misc", current);
            }
