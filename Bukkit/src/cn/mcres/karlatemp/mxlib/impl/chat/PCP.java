 ...
 * Reserved.FileName: PCP.java@author: karlatemp@vip.qq.com: 19-9-18 下午5:54@version: 2.0
 */
...
public class PCP implements BCAPI {
    ...
    public static final WrapperPlayServerChat chat = new WrapperPlayServerChat();

    @Override
    public void send(Player player, BCP packet) {
        final WrappedChatComponent component = WrappedChatComponent.fromJson(packet.toJSON());
